...
def tom_bkp():
	...
	api.local("mkdir -p /root/fabric/tombkp/"+ v_time)
	api.get("/tmp/bkp/*" , "/root/fabric/tombkp/"+v_time+"/")
	api.run("rm -rf /tmp/bkp")
	api.local("cd /root/fabric/bkp_servr ; fab bkp_tom")
	api.local("rm -rf /root/fabric/tombkp")
